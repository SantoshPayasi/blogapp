...
const Navigator = ({search, posts,  setPosts, searchList, setSearchList, isLoading, fetchError}) => {
...
useEffect(()=>{
  ...
  return (
    ...
    <Routes>
        ...
        <Route exact path="/post/:id" element={<PostPage posts={posts} handleDelete={handleDelete} setEditBody={setEditBody} setEditTitle={setEditTitle} />} />
